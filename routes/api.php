...
# Interactions
Route::get('interactions/{postPlatformId}', [InteractionController::class, 'getInteractionsByPostPlatformId']);

# Content
Route::post('contents', [ContentController::class, 'enhanceContent']);
